...
CREATE TABLE IF NOT EXISTS t_coingecko_platform_volume_snapshot (
    ...
    data_source VARCHAR(32) NOT NULL DEFAULT 'coingecko',
...
ALTER TABLE t_top30_snapshot
    ...
    ADD COLUMN data_source VARCHAR(32) NOT NULL DEFAULT 'coingecko' AFTER suggested_action,
...
ALTER TABLE t_daily_volume_aggregate
    ADD COLUMN data_source VARCHAR(32) NOT NULL DEFAULT 'native' AFTER status,
    ADD COLUMN source_endpoint VARCHAR(255) NULL AFTER data_source,
